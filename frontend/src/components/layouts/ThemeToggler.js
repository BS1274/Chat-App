...
export default function ThemeToggler() {
  // Refs to control theme toggle icons
  const themeToggleDarkIcon = useRef();
  const themeToggleLightIcon = useRef();

  useEffect(() => {
    // Check localStorage or system preference for theme and apply it
    if (
  ...
  const handleThemeToggle = () => {
    ...
    // Toggle theme in localStorage and update document element class
